...
import {
	PpcnReviewNewFormData,
	ReviewStatus
} from "@app/ppcn/ppcn-review-new-form-data";
...
export class NewReviewComponent implements OnInit {
	...
	constructor(
		...
		this.ppcnObservable = this.service
	...
	onSubmission(context: any) {
		this.formData.append("comment", context.context.commentCtrl);
		this.formData.append("fsm_state", context.context.statusCtrl);
		this.formData.append(
			"user",
			String(this.authenticationService.credentials.id)
		);
	}
}
