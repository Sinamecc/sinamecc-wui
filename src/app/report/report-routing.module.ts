...
const routes: Routes = [
	{
		...
		data: { title: extract("reportData.reports") }
	},
	{
		path: ":id/versions",
		component: ReportVersionsComponent,
		data: { id: extract("id") }
	},
	{
		path: "new",
		component: ReportNewComponent,
		data: { title: extract("reportData.createReport") }
	},
	{
		path: ":id/versions/new",
		component: ReportVersionsNewComponent,
		data: { title: extract("reportData.newVersion") }
	}
];
