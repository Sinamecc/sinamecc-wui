import { Component, OnInit, ElementRef, ViewChild, EventEmitter, Input, AfterViewInit } from '@angular/core';
...
import { MitigationActionNewFormData, FinanceSourceType, RegistrationType } from '@app/mitigation-actions/mitigation-action-new-form-data';
