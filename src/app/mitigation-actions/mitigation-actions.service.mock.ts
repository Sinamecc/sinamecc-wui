...
export class MockMitigationActionsService {
    ...
    this.someMitigationActions = [
      {
        ...
        start_date: moment(new Date(+(new Date()) - Math.floor(Math.random() * 10000000000)))
          .format('MM/DD/YYYY'),
        end_date: moment(new Date(+(new Date()) - Math.floor(Math.random() * 10000000000)))
          .format('MM/DD/YYYY'),
        institution: {
          id: Math.random().toString(36).substring(5),
          name: 'MINAE'
        ...
        updated: moment(new Date(+(new Date()) - Math.floor(Math.random() * 10000000000)))
          .format('MM/DD/YYYY'),
        fsm_state: 'created',
        files: [{ name: 'test 1', file: Math.random().toString(36) },
  ...
  newMitigationActionFormData(language: string, registration_type: string): Observable<MitigationActionNewFormData> {
    const newFormData: MitigationActionNewFormData = {
      ...
      institutions: [{ id: +Math.random().toString(36).substring(5), name: 'MINAE' },
      { id: +Math.random().toString(36).substring(5), name: 'DINADECO' },
      { id: +Math.random().toString(36).substring(5), name: 'DCC' }],
      statuses: [{ id: +Math.random().toString(36).substring(5), status: 'DCC approved' },
      { id: +Math.random().toString(36).substring(5), status: 'DCC rejected' }],
      finances: [{ id: +Math.random().toString(36).substring(5), name: 'Loan 31313', source: 'IMF' },
      { id: +Math.random().toString(36).substring(5), name: 'Loan 31314', source: 'WEF' }],
      ingei_compliances: [{ id: +Math.random().toString(36).substring(5), name: 'Ingei Compliance #1' },
      { id: +Math.random().toString(36).substring(5), name: 'Ingei Compliance #2' }],
      geographic_scales: [{ id: +Math.random().toString(36).substring(5), name: 'Local' },
      { id: +Math.random().toString(36).substring(5), name: 'Regional' }],
      finance_source_types: [{ id: +Math.random().toString(36).substring(5), name: 'Local' },
