  ...
  ndcList = [
    {
      ...
      options: [
        ...
        {
          name: 'En el año 2030, al menos el 8% de la flota de transporte público del país será cero emisiones.',
          code: '1.4',
        },
        {
          name:
    ...
    },
    {
      ...
      options: [
        {
          name: 'En el año 2025, al menos 10 municipalidades implementan el Plan Nacional de Compostaje.',
          code: '6.1',
        },
        {
          name:
    ...
    },
    {
      ...
      options: [
        ...
        {
          name: 'En el año 2030, el país mantendrá una tasa de deforestación cero en bosque maduro.',
          code: '8.5',
        },
        {
          name:
    ...
    },
    {
      ...
      options: [
        {
          name: 'Al 2022, el 30% de nuestro océano se encontrará bajo algún esquema oficial de protección.',
          code: '9.1',
        },
        {
          name:
    ...
    },
    {
      ...
      options: [
        ...
        {
          name: 'Al 2022, el país ha generado un Plan para la Integración de las Juventudes en la Acción Climática.',
          code: '10.10',
        },
        {
          name:
    ...
    },
    {
      ...
      options: [
        ...
        {
          name: 'Al 2022, se encuentra en implementación el Plan de Gestión de Riesgo de Desastres 2021-2025',
          code: '13.8',
        },
        {
          name:
  ...
  ejeList = [
    {
      ...
      options: [
        ...
        {
          name: 'En el 2050 el 85% de la flota de transporte público será cero emisiones.',
          code: '1.3',
        },
        {
          name:
    ...
    },
    {
      ...
      options: [
        ...
        {
          name: 'Al 2050 se habrán consolidado nuevos modelos y esquemas de movilidad compartida.',
          code: '2.3',
        },
        {
          name:
    ...
    this.form = this.formBuilder.group({
      formArray: this.formBuilder.array([
        this.formBuilder.group({
          ...
          initiativeDescriptionCtrl: ['', [Validators.required, Validators.maxLength(350)]],
          initiativeGoalCtrl: ['', [Validators.required, Validators.maxLength(200)]],
        }),
        this.formBuilder.group({
          ...
          initiativePositionCtrl: ['', [Validators.required, Validators.maxLength(40)]],
